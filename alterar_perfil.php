 			...
 			<div class="container cc-experience area_clones">
 				...
 				<div class="card card_exp_profissional">
 					<div class="row">
 						<div class="col-md-3 bg-dark">
 							<div class="card-body cc-experience-header">
 								<div id="tbg"><input type="text" value="<?=$resultadoPerfil4['data_profissao']?>" name="data_profissao[]" id="data_profissao" class="col-sm-12" placeholder="Data ex: Jan 2010 - Abril 2016"></div>
 								<div class="h5 mt-3" id="tbg"><input type="text" value="<?=$resultadoPerfil4['cargo']?>" name="cargo[]" id="cargo" class="col-sm-12" placeholder="Cargo" row="2"></div>
 							</div>
 						</div>

 						<div class="col-md-9" >
 							<div class="card-body" id="tbg1">
 								<div class="h5" id="tbg1"><button type="button" class="btn remover_card" style="background-color: white !important; font-size:15px; color: black; float: right;">X</button><input type="text" value="<?=$resultadoPerfil4['profissao']?>" name="profissao[]" id="profissao" class="col-sm-11" placeholder="Profissão" row="2"></div>
 								<textarea id="textArea2" class="md-textarea form-control"  name="sobre_profissao[]" rows="4" placeholder="O que você fazia na sua antiga profissão"><?=$resultadoPerfil4['sobre_profissao']?></textarea>
 							</div>
 						</div>
 					</div>
 				</div>
 			...
 			<div class="container cc-education area_clones">
 				...
 				<div class="card card_escolaridade">
 					<div class="row box_pergunta hide">
 						<div class="col-md-3 bg-dark">
 							<div class="card-body cc-education-header">
 								<div id="tbg"><input type="text" value="<?=$resultadoPerfil3['data_escolaridade']?>" name="data_escolaridade[]" id="data_escolaridade" class="col-sm-12" placeholder="Data ex: Jan 2014 - Dez 2017"></div>
 								<div class="h5 mt-3" id="tbg"><input type="text" value="Ensino Superior" name="ensino_superior[]" id="ensino_superior" class="col-sm-11" value="Ensino Superior" disabled="" row="2"></div>
 							</div>
 						</div>

 						<div class="col-md-9" >
 							<div class="card-body" id="tbg1">
 								<div class="h5" id="tbg1"><button type="button" class="btn remover_card" style="background-color: white !important; font-size:15px; color: black; float: right;">X</button><input type="text" value="<?=$resultadoPerfil3['nome_faculdade']?>" name="nome_faculdade[]" id="nome_faculdade" class="col-sm-11" placeholder="Nome da faculdade" row="2"></div>
 								<textarea id="textArea2" class="md-textarea form-control" name="curso[]" rows="4" placeholder="Ex: Engenheiro de Software "><?=$resultadoPerfil3['curso']?></textarea>
 							</div>
 						</div>
 					</div>
 				</div>
 				...
 				<div class="card">
 					<div class="row">
 						<div class="col-md-3 bg-dark">
 							...
 							<div class="card-body cc-education-header">
 								<div id="tbg"><input type="text" value="<?=$resultadoPerfil2['data_escolaridade_medio']?>" name="data_escolaridade_medio" id="data_escolaridade_medio" class="col-sm-12" placeholder="Data ex: Jan 2010 - Dez 2013"></div>
 				...
 				<div class="card">
 					<div class="row">
 						<div class="col-md-3 bg-dark">
 							...
 							<div class="card-body cc-education-header">
 								<div id="tbg"><input type="text" value="<?=$resultadoPerfil2['data_escolaridade_fundamental']?>"  name="data_escolaridade_fundamental" id="fundamental" class="col-sm-12" placeholder="Data ex: Jan 2002 - Dez 2010"></div>
 						...
 						<div class="col-md-9" >
 							<div class="card-body" id="tbg1">
 								<div class="mt-3" id="tbg1"  style="font-size:21px;"> <input type="text" 
 									value="<?=$resultadoPerfil2['nome_fundamental']?>" name="nome_fundamental" id="nome_fundamental" class="col-sm-12" placeholder="Nome da escola" row="2" required=""></div>
 									<textarea name="ensino_fundamental" class="md-textarea form-control" rows="4" placeholder="Ex: Ensino fundamental completo" required=""><?=$resultadoPerfil2['ensino_fundamental']?></textarea>
 								</div>
 							</div>
 						</div>
 					</div>
