 					...
 					<div class="page-header page-header-small" filter-color="green">
 						...
 						<div class="container"> 
 							<div class="content-center">
 								...
 								<input type="text" name="nome" id="nome" class="col-sm-6" value="<?=$resultadoPerfil1['nome']?>" placeholder="Digite seu Nome" required="" style="background-color: rgba(10,23,55,0); color: white; border: none !important; text-align: center; font-size: 35px; font-weight: 700;">
 							</div>
 						</div>
 					</div>
 				</div>
